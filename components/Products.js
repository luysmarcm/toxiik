...
const Products = () => {
	return (
		<section id="products" class="relative w-auto py-10">
			...
			<div  className="w-scream grid grid-cols-4 bg-blue-400 ">
				<div className="flex flex-col col-span-4 md:col-span-2 lg:row-span-2 lg:p-14">
					<div className="flex-1 aspect-w-4 aspect-h-3 lg:aspect-h-4">
						...
						<div className="flex flex-col p-8 lg:flex-row items-center">
							<img
								className="object-cover sm:w-8/12 sm:h-3/5 md:w-8/12 md:h-3/5"
							...
							<div className="flex-col -space-y-2">
								...
								<div className="font-mont font-extrabold bg-clip-text text-transparent	bg-fondoT bg-cover bg-left text-6xl ">
									CHAR
								</div>
								<div className="text-black font-mont font-extrabold bg-left-top bg-clip-text text-transparent	bg-fondoT bg-cover text-6xl ">
									GER
								</div>
